      ...
      <div>
        <nav className="flex items-center justify-between flex-wrap bg-red-500 p-6">
          ...
          <div className="flex flex-wrap items-center text-center sm:m-auto md:mr-5 text-white">
            ...
            <a target="_blank" rel="noopener noreferrer" className="bg-red-400 hover:bg-red-300 font-bold py-2 sm:mt-5 md:m-auto px-4 border-b-4 border-red-600 hover:border-red-400 rounded" href={apiConf.calendarURL}>View Calendar</a>
